...
impl<'a> TopLevelExpr<'a> {
    pub fn parse(input: &'a str) -> IResult<&'a str, Self> {
        alt((
                | input: &'a str | { let (remnant, (expr1, _, _, _, expr2, _, _)) = tuple((L1Expr::parse, multispace0, tag("="), multispace0, Expr::parse, multispace0, tag(";")))(input)?; Ok((remnant, TopLevelExpr::Assign(expr1, expr2))) },
