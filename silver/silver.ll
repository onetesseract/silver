...
@global_str.77 = private unnamed_addr constant [5 x i8] c"main\00", align 1
@global_str.78 = private unnamed_addr constant [7 x i8] c"here20\00", align 1
@global_str.79 = private unnamed_addr constant [6 x i8] c"jhelp\00", align 1
@global_str.80 = private unnamed_addr constant [5 x i8] c"here\00", align 1
@global_str.81 = private unnamed_addr constant [5 x i8] c"aaaa\00", align 1
@global_str.82 = private unnamed_addr constant [10 x i8] c"checking\0A\00", align 1
@global_str.83 = private unnamed_addr constant [18 x i8] c"getelem checking\0A\00", align 1
@global_str.84 = private unnamed_addr constant [38 x i8] c"Getting an element that doesn't exist\00", align 1
@global_str.85 = private unnamed_addr constant [14 x i8] c"get checking\0A\00", align 1
@global_str.86 = private unnamed_addr constant [38 x i8] c"Getting an element that doesn't exist\00", align 1
...
entry_block:
  ...
  call void @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @global_str.77, i32 0, i32 0))
  call void @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @global_str.78, i32 0, i32 0))
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 25867, end: 25877, rendered-as: \22hmlist#new\22 } })_call" = call { i64, i8**, i1, i8* } @"hmlist#new"(i64 4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @global_str.79, i32 0, i32 0))
  store { i64, i8**, i1, i8* } %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 25867, end: 25877, rendered-as: \22hmlist#new\22 } })_call", { i64, i8**, i1, i8* }* %macro_arg_space, align 8
  ...
  call void @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @global_str.80, i32 0, i32 0))
  call void @hmlist_add({ i64, i8**, i1, i8* }* %q, i64 5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @global_str.81, i32 0, i32 0))
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 26039, end: 26049, rendered-as: \22hmlist_get\22 } })_call" = call i8** @hmlist_get({ i64, i8**, i1, i8* }* %q, i64 5)
  store i8** %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 26039, end: 26049, rendered-as: \22hmlist_get\22 } })_call", i8*** %macro_arg_space1, align 8
...
entry_block:
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 23025, end: 23031, rendered-as: \22malloc\22 } })_call" = call i8* @malloc(i64 ptrtoint (i8** getelementptr (i8*, i8** null, i32 1) to i64))
  %bitcast = bitcast i8* %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 23025, end: 23031, rendered-as: \22malloc\22 } })_call" to i8**
  store i8** %bitcast, i8*** %macro_arg_space, align 8
...
entry_block:
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22208, end: 22223, rendered-as: \22hmlist_contains\22 } })_call" = call i1 @hmlist_contains({ i64, i8**, i1, i8* }* %self_variable_load, i64 %hash_variable_load)
  br i1 %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22208, end: 22223, rendered-as: \22hmlist_contains\22 } })_call", label %if_then_block, label %if_else_block

if_then_block:                                    ; preds = %entry_block
  %self_variable_load1 = load { i64, i8**, i1, i8* }*, { i64, i8**, i1, i8* }** %self, align 8
  %hash_variable_load2 = load i64, i64* %hash, align 4
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22274, end: 22289, rendered-as: \22hmlist_get_elem\22 } })_call" = call { i64, i8**, i1, i8* }* @hmlist_get_elem({ i64, i8**, i1, i8* }* %self_variable_load1, i64 %hash_variable_load2)
  store { i64, i8**, i1, i8* }* %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22274, end: 22289, rendered-as: \22hmlist_get_elem\22 } })_call", { i64, i8**, i1, i8* }** %macro_arg_space, align 8
  %b_variable_load = load { i64, i8**, i1, i8* }*, { i64, i8**, i1, i8* }** %macro_arg_space, align 8
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22316, end: 22322, rendered-as: \22malloc\22 } })_call" = call i8* @malloc(i64 ptrtoint (i8** getelementptr (i8*, i8** null, i32 1) to i64))
  %bitcast = bitcast i8* %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22316, end: 22322, rendered-as: \22malloc\22 } })_call" to i8**
...
if_else_block:                                    ; preds = %entry_block
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22489, end: 22495, rendered-as: \22malloc\22 } })_call" = call i8* @malloc(i64 ptrtoint (i8** getelementptr (i8*, i8** null, i32 1) to i64))
  %bitcast13 = bitcast i8* %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22489, end: 22495, rendered-as: \22malloc\22 } })_call" to i8**
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22706, end: 22712, rendered-as: \22malloc\22 } })_call" = call i8* @malloc(i64 ptrtoint ({ i64, i8**, i1, i8* }* getelementptr ({ i64, i8**, i1, i8* }, { i64, i8**, i1, i8* }* null, i32 1) to i64))
  %bitcast29 = bitcast i8* %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 22706, end: 22712, rendered-as: \22malloc\22 } })_call" to { i64, i8**, i1, i8* }*
...
while_loop_body_basic_block:                      ; preds = %while_loop_cond_check_basic_block
  call void @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @global_str.82, i32 0, i32 0))
  ...
  %struct_gep_deref = load i64, i64* %struct_gep, align 4
  %hash_variable_load = load i64, i64* %hash, align 4
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21126, end: 21128, rendered-as: \22==\22 } })_call" = call i1 @"=="(i64 %struct_gep_deref, i64 %hash_variable_load)
  br i1 %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21126, end: 21128, rendered-as: \22==\22 } })_call", label %if_then_block, label %if_else_block
...
if_else_block:                                    ; preds = %while_loop_body_basic_block
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21162, end: 21163, rendered-as: \22!\22 } })_call" = call i1 @"!"(i1 %struct_gep_deref3)
  br i1 %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21162, end: 21163, rendered-as: \22!\22 } })_call", label %if_then_block4, label %if_else_block5
...
while_loop_body_basic_block:                      ; preds = %while_loop_cond_check_basic_block
  call void @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_str.83, i32 0, i32 0))
  %current_variable_load = load { i64, i8**, i1, i8* }*, { i64, i8**, i1, i8* }** %current, align 8
  %struct_gep = getelementptr inbounds { i64, i8**, i1, i8* }, { i64, i8**, i1, i8* }* %current_variable_load, i32 0, i32 0
  %struct_gep_deref = load i64, i64* %struct_gep, align 4
  %hash_variable_load = load i64, i64* %hash, align 4
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21910, end: 21912, rendered-as: \22==\22 } })_call" = call i1 @"=="(i64 %struct_gep_deref, i64 %hash_variable_load)
  br i1 %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21910, end: 21912, rendered-as: \22==\22 } })_call", label %if_then_block, label %if_else_block
...
if_else_block:                                    ; preds = %while_loop_body_basic_block
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21949, end: 21950, rendered-as: \22!\22 } })_call" = call i1 @"!"(i1 %struct_gep_deref4)
  br i1 %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21949, end: 21950, rendered-as: \22!\22 } })_call", label %if_then_block5, label %if_else_block6
...
while_loop_body_basic_block:                      ; preds = %while_loop_cond_check_basic_block
  call void @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_str.85, i32 0, i32 0))
  %current_variable_load = load { i64, i8**, i1, i8* }*, { i64, i8**, i1, i8* }** %current, align 8
  %struct_gep = getelementptr inbounds { i64, i8**, i1, i8* }, { i64, i8**, i1, i8* }* %current_variable_load, i32 0, i32 0
  %struct_gep_deref = load i64, i64* %struct_gep, align 4
  %hash_variable_load = load i64, i64* %hash, align 4
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21480, end: 21482, rendered-as: \22==\22 } })_call" = call i1 @"=="(i64 %struct_gep_deref, i64 %hash_variable_load)
  br i1 %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21480, end: 21482, rendered-as: \22==\22 } })_call", label %if_then_block, label %if_else_block
...
if_else_block:                                    ; preds = %while_loop_body_basic_block
  ...
  %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21525, end: 21526, rendered-as: \22!\22 } })_call" = call i1 @"!"(i1 %struct_gep_deref6)
  br i1 %"Named(VariableExpr { name: LexString { lexer: \22...\22, start: 21525, end: 21526, rendered-as: \22!\22 } })_call", label %if_then_block7, label %if_else_block8

if_cont_block:                                    ; preds = %if_cont_block9, %if_then_block
  br label %while_loop_cond_check_basic_block

if_then_block7:                                   ; preds = %if_else_block
  call void @panic(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @global_str.86, i32 0, i32 0))
