...
pub mod id {
    use nom::{combinator::recognize, sequence::pair, branch::alt, bytes::complete::tag, IResult, character::complete::{alphanumeric1, alpha1}, multi::many0_count};

    pub fn parse_id(input: &str) -> IResult<&str, &str> {
        recognize(
            pair(
                alt((alpha1, tag("_"))),
